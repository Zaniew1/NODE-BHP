...
const WorkerCreateSchema = z.object({
  name: z.string({ required_error: 'Name is required' }).trim().min(3, 'Name to short, 3 chars minimum').max(50, 'Name too long, 50 chars maximum'),
  secondName: z
  ...
  surname: z
    ...
    .optional(),
  author: z.number({ required_error: 'Author is required' }).optional(),
  ...
  placeOfBirth: z.string().trim().max(50, 'Place of birth too long, 100 chars maximum'),
